...
namespace budget_api.Controllers
{
    ...
    public class TransactionController : BudgetApiBaseController
    {
        ...
        /// <summary>
        /// Dodaje nowy przychód do wskazanego budżetu.
        /// </summary>
        /// <param name="budgetId">ID budżetu, do którego dodajemy przychód.</param>
        /// <param name="model">Dane nowego przychodu (kwota, tytuł, kategoria).</param>
        ...
        /// </summary>
        /// <remarks>
        /// Obsługuje paginację, sortowanie po kolumnach i wyszukiwanie tekstowe.
        ...
        /// <returns>Obiekt z listą transakcji i metadanymi dla tabeli.</returns>
        ...
        /// <summary>
        /// Pobiera szczegóły pojedynczego przychodu.
        /// </summary>
        /// <param name="budgetId">ID budżetu.</param>
        /// <param name="incomeId">ID transakcji (przychodu).</param>
        /// <returns>Szczegółowe dane transakcji.</returns>
        ...
        /// </summary>
        /// <remarks>
        /// Uwaga: Usunięcie przychodu wpływa na całkowite saldo budżetu.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Metoda weryfikuje, czy w budżecie są wystarczające środki. 
        /// Jeśli `Amount` > Saldo, zwracany jest błąd 400 (Bad Request).
        /// </remarks>
        /// <param name="budgetId">ID budżetu.</param>
        ...
        /// <summary>
        /// Pobiera szczegóły pojedynczego wydatku.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Również sprawdza saldo. Jeśli zwiększenie kwoty wydatku spowodowałoby ujemny bilans, operacja zostanie odrzucona.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Usunięcie wydatku zwraca środki do salda budżetu.
        /// </remarks>
